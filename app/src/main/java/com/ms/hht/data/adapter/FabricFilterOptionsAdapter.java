...
import com.ms.hht.ui.customization.Fabric_Select.ViewAdapter.ColorPatternAdapterClass;

import java.util.List;

public class FabricFilterOptionsAdapter extends RecyclerView.Adapter<FabricFilterOptionsAdapter.MyViewHolder> {

    Context context;
    List<FabricFilterListResponse.DataItem> data;
    public static int filterOptionAdapterPosition = -1;

    public FabricFilterOptionsAdapter(Context context, List<FabricFilterListResponse.DataItem> data) {
    ...
    @NonNull
    @Override
    public FabricFilterOptionsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view3 = inflater.inflate(R.layout.filter_recycler_layout, parent, false);
        return new FabricFilterOptionsAdapter.MyViewHolder(view3);
    }

    @Override
    public void onBindViewHolder(@NonNull FabricFilterOptionsAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        ColorPatternAdapterClass patternAdapterClass = new ColorPatternAdapterClass(context, data.get(position).getOptions());

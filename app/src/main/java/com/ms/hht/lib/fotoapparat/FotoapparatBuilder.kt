...
import com.ms.hht.lib.fotoapparat.view.FocusView
import com.ms.hht.lib.fotoapparat.preview.FrameProcessor as FrameProcessorJava
...
class FotoapparatBuilder internal constructor(private var context: Context) {
     ...
     * @see com.ms.hht.lib.fotoapparat.log.Loggers
     */

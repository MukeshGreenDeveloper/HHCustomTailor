...
package com.ms.hht.lib.fotoapparat.parameter

import android.hardware.Camera
import com.ms.hht.lib.fotoapparat.parameter.extract.extractRawCameraValues
import com.ms.hht.lib.fotoapparat.util.toInts
...
internal class SupportedParameters(
    ...
    /**
     * @return [com.ms.hht.lib.fotoapparat.parameter.Zoom.FixedZoom] if [Camera.Parameters.isZoomSupported] returns false,
     * and [com.ms.hht.lib.fotoapparat.parameter.Zoom.VariableZoom] with max zoom level otherwise.
     */
